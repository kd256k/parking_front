        ...
        { showCurrent && 
            <div className='w-full h-screen inset-0 bg-black/50 flex items-center justify-between absolute top-0 left-0 z-100 text-white'>
                <div className="w-1/3 h-full flex">
                    <div className="w-80 h-full bg-green-500/50">
                        영역1
                    </div>
                    <div className="flex-1 h-full bg-yellow-500/50">
                        영역2
                    </div>
                </div>
                <div className='w-1/3 h-full flex flex-col justify-center'>
                    <div className='w-full flex-1 bg-red-500/50'>
                        영역3
                    </div>
                ...
                <div className="w-1/3 h-full flex flex-col">
                    <div className="w-full h-1/2 bg-green-500/50">
                        영역4
                    </div>
                    <div className="flex-1 h-1/2 bg-yellow-500/50">
                        영역5
                    </div>
                </div>
            </div>
